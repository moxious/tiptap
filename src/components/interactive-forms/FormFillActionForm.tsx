...
const FormFillActionForm = ({ editor, onApply, onCancel, initialValues }: InteractiveFormProps) => {
  ...
  return (
    <div className="interactive-form">
      <h4>Form Fill Action</h4>
      <p className="form-description">Fill a form input field</p>
      ...
      <div className="form-field">
        ...
        <input
          ...
          autoFocus
        />
        <span className="field-hint">CSS selector for the input field</span>
      </div>
